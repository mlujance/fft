...
class AnalysisWorker(QObject):
    ...
    def __init__(self, input_file, output_dir, output_name, references, search_references, fs, cwt_wavelet, dwt_wavelet):
        super().__init__()
    ...
    def run(self):
        ...
        try:
            import back_end_22 as analyzer
            ...
            analyzer.build_original_report_with_appendix(metrics, paths, self.input_file, matches)
