...
def _reference_appendix_flowables(matches):
    ...
    for match_index, match in enumerate(matches):
        ...
        bit_string = _reference_bit_string(match.bits)

        # Keep individual lines compact enough for the A4 report width.
        bit_lines = [
            bit_string[i:i + 96]
            for i in range(0, len(bit_string), 96)
        ]
